...
from hr_services.permissions.contract_expiry import throw_unless_administrator
...
def send_contract_expiry_notifications():
	...
	frappe.db.set_value(
		SETTINGS_DOCTYPE, SETTINGS_DOCTYPE, "last_run_on", now_datetime(), update_modified=False
	)
	frappe.db.commit()
